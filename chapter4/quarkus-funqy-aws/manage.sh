...
FUNCTION_NAME=QuarkusFunqyAws
HANDLER=io.quarkus.funqy.lambda.FunqyStreamHandler::handleRequest
RUNTIME=java21
ZIP_FILE=fileb:///home/kdubois/workspace/serverless-java-in-action/examples/chapter4/quarkus-funqy-aws/target/function.zip
...
then
  RUNTIME=provided
  ZIP_FILE=fileb:///home/kdubois/workspace/serverless-java-in-action/examples/chapter4/quarkus-funqy-aws/target/function.zip
  FUNCTION_NAME=QuarkusFunqyAwsNative
